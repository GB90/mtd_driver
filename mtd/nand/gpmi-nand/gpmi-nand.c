...
static int gpmi_init_last(struct gpmi_nand_data *this)
{
    ...
    pr_info("<luowei : gpmi_init_last() NAND_ECC_HW>\n");//会执行
...
static int gpmi_nand_init(struct gpmi_nand_data *this)
{
    ...
    pr_info("<luowei : gpmi_nand_init()--ok>\n");
    gpmi_dump_info(this);//打印信息 luowei
	return 0;
...
{
    struct gpmi_nand_data *this;//在此创建的gpmi_nand_data luowei
