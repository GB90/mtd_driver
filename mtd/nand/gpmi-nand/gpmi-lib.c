...
void gpmi_dump_info(struct gpmi_nand_data *this)
{
	...
	dev_err(this->dev, "BCH Geometry :\n"
        ...
        geo->ecc_chunk_count,//4
        geo->payload_size,//2048
        geo->auxiliary_size,//16
        geo->auxiliary_status_offset,//12
        geo->block_mark_byte_offset,//1999
        geo->block_mark_bit_offset);//0
}
